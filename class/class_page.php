...
class Page
{
    ...
    public function printHead()
    {
        ...
        ?>
        <meta name="author" content="ozbekistanhaber.com">
        ...
        <meta name="generator" content="www.ozbekistabhaber.com"/>
        ...
        <meta property="og:site_name" content="ozbekistabhaber.com">
            <?php
        if ($GLOBALS['site_url']) {
            ?>
       ...
       <?php
        ...
        ?>
        <?php
        if ($GLOBALS['page_soc_image_first_image']) {
            ?>
        <meta property="og:image" content="<?php echo $GLOBALS['page_soc_image_first_image']; ?>"/>
            <?php
              }
        ?>
        ...
        <meta name="twitter:image" content="<?php echo $GLOBALS['page_soc_image']; ?>" />
            <?php } ?>
        <meta name="twitter:creator" content="@vodiymedia_uz" />
