<link rel="stylesheet" href="/modules/mod_dt_newsscroll/css/style8/newsscroll.css" type="text/css" />

<div id="dt_newsscrollwrap<?php echo $module_id ?>" class="dt_newsscrollwrap style8" style="z-index: 100; width: 940px;">
