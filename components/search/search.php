...
//    $cfg = loadConfig();
    ...
    if ($query && strlen($query)>=3){
        ...
        echo '<div class="search-form-light">';
...
//				  </select> </p>';
        echo '<p><input class="btn btn-primary" type="submit" value="ARA"/>';
...
//				  </p>';
            ...
            echo '<div class="list-item-search-light">';
            $n = 0+(($page-1)*$perpage);
            ...
            foreach($acon as $con){
                ...
                $n++;
                echo '<div class="item-search-light">';
                echo '<div class="row">';
//                echo $n.'.';
                echo '<div class="col-md-12 col-sm-7 col-xs-12">
											<div class="search-light-info">
												<h3><a href="'.$url.'"><b>'.preg_replace('/(?i)' . $query . '/', '<i style="background:#FFFF00">' . $query . '</i>', $con['title']).'</b></a><br/></h3>
												'.preg_replace('/(?i)' . $query . '/', '<i style="background:#FFFF00">' . $query . '</i>', $con['introtext']).'
