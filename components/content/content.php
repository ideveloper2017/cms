...
//            $article['image'] = (file_exists(PATH . '/images/content/' . $modarticle->images) ? $modarticle->images : '');
            ...
            $article['plugins']=$modarticle->content;
            ...
            if ($sit_url) {
              ...
              if (isset($article['first_image'])) {
                $GLOBALS['page_soc_image_first_image'] = 'https://' . $_SERVER['HTTP_HOST'].$article['first_image'];
            }
            
            if (isset($article['image'])) {
                $GLOBALS['page_soc_image'] = 'https://' . $_SERVER['HTTP_HOST']  . $article['image'];
            }
